...
DFLAGS=-conf= -g -gs -debug=FastCompilingFormat -release -w -dip25 -I$(DRUNTIME)\import
#DFLAGS=-unittest -g
#DFLAGS=-unittest -cov -g

## Flags for compiling unittests

UDFLAGS=-conf= -w -g -gs -release -dip25 -I$(DRUNTIME)\import

## C compiler

CC=dmc
AR=C:\DigitalMars\bin\lib.exe
MAKE=c:\DigitalMars\bin\make.exe
